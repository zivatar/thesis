...
def get_image_path_site1(instance, filename):
    """
    Returns absolute path of an uploaded image file

    :param instance: Site object instance
    :param filename: original file name
    :return: {BASE_PATH}/uploads/site/{id}
    """
...
class Site(models.Model):
    """
    | Site model and constants
    | Has an autogenerated primary key
    | Foreign key to User objects
    | Unique title
    """
    NARROW_AREA = (
        (1, 'kert'),
