...
class GravatarTestCase(unittest.TestCase):
	def test_empty_email(self):
		self.assertTrue(
			gravatar_url('') == 'https://www.gravatar.com/avatar/d41d8cd98f00b204e9800998ecf8427e?d=identicon&s=100' or
			gravatar_url('') == 'https://www.gravatar.com/avatar/d41d8cd98f00b204e9800998ecf8427e?s=100&d=identicon'
		)
	def test_real_email_without_gravatar(self):
		self.assertTrue(
			gravatar_url('rendeles10@gmail.com') == 
	...
	def test_real_email_with_gravatar(self):
		self.assertTrue(
			gravatar_url('macgyver1024@gmail.com') == 
	...
	def test_xl_size(self):
		self.assertTrue(
			gravatar_url('rendeles10@gmail.com', 512) == 
